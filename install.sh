...
definir_mensagens() {
    case $idioma in
        1)
            ...
            MSG_PASSO_2="${GREEN}✅ PASSO 2:${NC} Verificando a última versão do Ant Media Server..."
            ...
            MSG_PASSO_5="${GREEN}✅ PASSO 5:${NC} Instalando ou atualizando o Ant Media Server..."
            MSG_PASSO_6="${GREEN}✅ PASSO 6:${NC} Configurando as regras do iptables..."
            MSG_PASSO_7="${GREEN}✅ PASSO 7:${NC} Configurando as configurações adicionais de rede..."
        ...
        2)
            ...
            MSG_PASSO_2="${GREEN}✅ STEP 2:${NC} Checking the latest version of Ant Media Server..."
            ...
            MSG_PASSO_5="${GREEN}✅ STEP 5:${NC} Installing or updating Ant Media Server..."
            MSG_PASSO_6="${GREEN}✅ STEP 6:${NC} Configuring iptables rules..."
            MSG_PASSO_7="${GREEN}✅ STEP 7:${NC} Configuring additional network settings..."
...
if [[ $instalar =~ ^[SsYy]$ ]]; then
    ...
    # Passo 5
    echo -e "$MSG_PASSO_5"
    sudo ./install_ant-media-server.sh -i $FILENAME

    # Verificar se o serviço foi instalado e está ativo
